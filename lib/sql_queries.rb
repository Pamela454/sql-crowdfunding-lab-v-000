...
"SELECT projects.title, SUM((pledges.amount) - funding_goal.projects) FROM projects INNER JOIN pledges ON projects.id = pledges.id WHERE amount.pledges >= funding_goal.projects"
end

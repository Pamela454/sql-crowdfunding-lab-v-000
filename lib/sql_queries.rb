...
"SELECT projects.title, SUM((pledges.amount) - projects.funding_goal) FROM projects INNER JOIN pledges ON projects.id = pledges.id WHERE pledges.amount >= funding_goal.projects"
end

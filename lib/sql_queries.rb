...
"SELECT projects.title, SUM((amount.pledges) - funding_goal.projects) FROM projects INNER JOIN pledges ON projects.id = pledges.id WHERE amount.pledges >= funding_goal.projects"
end
